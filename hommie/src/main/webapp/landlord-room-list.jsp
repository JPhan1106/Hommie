...
<body>
	<div class="container-xxl bg-white p-0">
					...
					<nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
						...
						<div class="collapse navbar-collapse justify-content-between"
							...
							<div class="navbar-nav mr-auto py-0">
								...
								<div class="navbar-nav mr-auto py-0">
									<a href="#" class="nav-item nav-link active">Inspections</a> <a
										href="#" class="nav-item nav-link active">Earnings</a>
								...
								<div class="p-4 mt-2">
									...
									<div class="d-flex justify-content-between">
										<a class="btn btn-sm btn-primary rounded py-2 px-4"
											href="room?roomId=${room.id}">View Detail and Update</a>
		...
		<div class="container-xxl py-5">
			<div class="container">
				<div class="text-center wow fadeInUp" data-wow-delay="0.1s">
					<h4 class="section-title text-center text-primary text-uppercase"></h4>
					<h1 class="mb-5">
						...
						<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
							<div class="room-item shadow rounded overflow-hidden">
								...
								<div class="p-4 mt-2">
									...
									<div class="d-flex justify-content-between">
										<a class="btn btn-sm btn-primary rounded py-2 px-4"
											href="room?roomId=${room.id}">View Detail and Payment</a>
